        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li>
					...
					<li>
                        <a class="active-menu" href="reservation.php"><i class="fa fa-bar-chart-o"></i> Room Booking</a>
                    </li>
            ...
            <div id="page-inner">
                ...
                <?php if ($id == null) :?>
                    <div class="row">
                        ...
                        <ul id="bookinglist">
                            <?php foreach ($book->getAllBooking() as $key => $value) :?>
                                <li <?php if($value['stat'] == 'Canceled'){echo 'class="canceled"';}elseif($value['stat'] == 'Confirmed'){echo 'class="confirmed"';}?>><a href="edit-booking.php?rid=<?php echo $value['id']?>"><span><?php echo $value['Title']?> <?php echo $value['FName']?> <?php echo $value['LName']?></span><span><?php echo $value['stat']?></span></a></li>
                            <?php endforeach;?>
                        </ul>
                    </div>  
                <?php else: ?>
